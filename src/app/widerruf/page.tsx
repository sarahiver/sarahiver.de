...
export const metadata = { title: 'Widerruf — sarahiver.de', robots: { index: false, follow: false } };
...
export default function Widerruf() {
  return (
    <main className="px-6 md:px-12 lg:px-20 py-16 max-w-3xl mx-auto">
      ...
      <h1 className="display mt-8 mb-12">Widerrufsbelehrung</h1>

      <p className="text-ink-soft leading-relaxed">
        Die Widerrufsbelehrung wird vor dem Launch hier veröffentlicht.
      </p>
